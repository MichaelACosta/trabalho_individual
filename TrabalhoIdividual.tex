...
O trabalho \todo{citar}, categoriza as técnicas de escalonamento de STM em ...., esta caracterização é apresentada na Figura~\todo{referenciar}, com objetivo de simplificar a estrutura de escalonamento.

Para cada característica de escalonamento citado acima, existem diferentes técnicas que foram exploradas e exemplificadas em~\todo{citar}. As subseções a seguir vão abordar e detalhar estas técnicas assim como seus algoritmos.
