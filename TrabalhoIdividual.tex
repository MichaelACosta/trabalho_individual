...
\chapter{Escalonamento de STM}
  ...
  Conforma a figura \todo{referenciar}, o trabalho \todo{citar}, caracteriza os escalonadores como ...

  Para cada caracteristica de escalonamento citado acima, existem diferentes tecnicas que serão exploradas e exemplificadas nas subseções abaixo.

\section{Analysis, classification and comparison of scheduling techniques for software transactional memories}
